...
class CreditDataPreprocessor:
    ...
    def preprocess(self, save_data: bool = True,
        ...
        # Step 1: Remove unnecessary index column
        print("\nStep 1: Removing unnecessary index column...")
        self.remove_index_column()
